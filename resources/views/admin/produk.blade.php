            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <form action="{{ route('produkAdmin') }}" method="GET" class="w-100">
                            <div class="d-flex flex-wrap align-items-center gap-3 py-2">
                                ...
                                <div class="flex-grow-1 min-w-0 ">
                                    <input type="text" name="search" value="{{ request('search') }}"
                                        ...
                                        placeholder="Cari produk..." style="height:44px; font-size:14px; min-width:150px;padding-left: 18px;">
                                </div>
                                ...
                                <select name="sort" class="tgl-dbuat form-select mx-1 form-select-sm border-0 bg-white text-dark rounded-pill px-2"
                                    ...
                                    <option value="kategori" {{ request('sort') == 'kategori' ? 'selected' : '' }}>Kategori</option>
                                ...
                                <div class="d-flex align-items-center gap-2 mx-1">
                                    ...
                                    <a href="{{ route('produkAdmin') }}" class="btn mx-1 btn-light border rounded-pill d-flex align-items-center text-muted"
